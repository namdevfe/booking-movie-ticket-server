...
export const logoutSchema = Joi.object<LogoutPayload>({
  refreshToken: Joi.string().required().trim().strict().messages({
    'string.base': 'Refresh token must be a string',
    'string.empty': 'Refresh token cannot be empty',
    'string.trim': 'Refresh token must not have leading or trailing whitespace',
